	...
	return &models.BuiltinStrategy{
		...
		Inputs: []models.StrategyInput{
			...
			},
			{
				...
				Type:          models.InputTypeNumberInput,
				Suffix:        "%",
				Constraints:   map[string]any{models.ConstraintMin: 0, models.ConstraintMax: 1, models.ConstraintDecimals: 2},
				DefaultValue:  0,
				Caption:       "Applied on entry and exit. Type decimal percent — e.g. 0.05 for 0.05%.",
